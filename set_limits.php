...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (isset($_SESSION['username'])) {
        ...
        $Budget_Limit_name = htmlspecialchars($_POST['BudgetLimitname']);

        $budgetlimit = intval($_POST['budget_Limit']); // Convert to integer
    ...
    $sql = "INSERT INTO budgetlimit (username,BudgetLimitname,budget_Limit) VALUES ('$username', '$Budget_Limit_name',$budgetlimit)";

    if ($conn->query($sql) === TRUE) {
        echo "<p>budget limits saved successfully!</p>";
    } else {
